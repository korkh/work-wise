...
export function getSummarizedBusinessTrips(businessTrips) {
    const summaries = {};
    businessTrips.forEach((trip) => {
        if (!trip.laikotarpis || !trip.employeeId || !trip.employee)
            return;
    ...
    Object.values(summaries).forEach((summary) => {
        ...
        if (summary.formerYearLikutis) {
            summary.formerYearLikutis = parseFloat(summary.formerYearLikutis.toFixed(2));
