...
const BusinessTripsSummariesPage = () => {
    ...
    return (_jsx(DynamicReducerLoader, { reducers: reducers, removeAfterUnmount: false, children: _jsx(BusinessTripsInfiniteList, { variant: getRouteBusinessTripsSummaries() }) }));
};
