...
export const deleteEmployeeById = createAsyncThunk("employeeDetails/deleteEmployeeById", async (employeeId, thunkApi) => {
    ...
    try {
        ...
        const response = await extra.api.delete(`/employees/${employeeId}`, {
            headers: {
