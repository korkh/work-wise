        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationAddressId = table.Column<Guid>(type: "TEXT", nullable: true),
                    PhoneNumber = table.Column<string>(type: "TEXT", nullable: true),
                    IsAvailable = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsFired = table.Column<bool>(type: "INTEGER", nullable: false),
                    ContractDataId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Employees_Address_RegistrationAddressId",
                        column: x => x.RegistrationAddressId,
                        principalTable: "Address",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Employees_Contract_ContractDataId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_ContractDataId",
                table: "Employees",
                column: "ContractDataId");

            migrationBuilder.CreateIndex(
                name: "IX_Employees_RegistrationAddressId",
                table: "Employees",
